...
│   ├── admin-config.html         # Legacy: reporting URL config page
...
├── .github/
│   └── workflows/
│       └── keep-supabase-alive.yml  # Scheduled ping to prevent Supabase pausing
└── README.md
🙏 Credits
...
© 2026 Manchester Metropolitan University. All rights reserved. Not currently licensed for redistribution.
